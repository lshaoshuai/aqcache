...
class CreateAqCacheTest {
    ...
    void contextLoads() {
        try {
            ...
            Mat mat6 = new Mat(6, 6, CV_8UC1, new Scalar(0));
            ...
            cacheTools.test.put("key6", mat6);
            cacheTools.test.get("key2");
            System.out.println(cacheTools.test.getEldestEntry().getValue());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
