 ...
 */
public abstract class AqCacheCondition extends SpringBootCondition {

    private String[] cacheTypes;

    protected AqCacheCondition(String... cacheTypes) {
    ...
    public ConditionOutcome getMatchOutcome(ConditionContext conditionContext, AnnotatedTypeMetadata annotatedTypeMetadata) {
        ConfigTree ct = new ConfigTree((ConfigurableEnvironment) conditionContext.getEnvironment(), "aqcache.");
