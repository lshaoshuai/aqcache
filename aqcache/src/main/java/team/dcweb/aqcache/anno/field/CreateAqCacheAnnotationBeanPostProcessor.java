...
public class CreateAqCacheAnnotationBeanPostProcessor extends AutowiredAnnotationBeanPostProcessor {

    private static Logger logger = LoggerFactory.getLogger(CreateAqCacheAnnotationBeanPostProcessor.class);
        ...
        do {
            ...
            doWithLocalFields(targetClass, new ReflectionUtils.FieldCallback() {
                ...
                public void doWith(Field field) throws IllegalArgumentException, IllegalAccessException {
                    CreateAqCache ann = field.getAnnotation(CreateAqCache.class);
                    if (ann != null) {
    ...
    private class AutowiredFieldElement extends InjectionMetadata.InjectedElement {
        ...
        public AutowiredFieldElement(Field field, CreateAqCache ann) {
            super(field, null);
            this.field = field;
            this.ann = ann;
        }
        ...
        protected void inject(Object bean, String beanName, PropertyValues pvs) throws Throwable {
            beanFactory.registerDependentBean(beanName, "globalAqCacheConfig");
            LazyInitAqCache cache = new LazyInitAqCache(beanFactory, ann, field);
