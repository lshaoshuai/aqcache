...
public abstract class AbstractAqMap<K, V> implements Map<K, V> {
    /**
     * Sole constructor.  (For invocation by subclass constructors, typically
     * implicit.)
     */
    protected AbstractAqMap() {
    }
    ...
    public Set<K> keySet() {
        ...
        if (ks == null) {
            ks = new AbstractSet<K>() {
                ...
                @Override
                public int size() {
                    return AbstractAqMap.this.size();
                }

                @Override
                public boolean isEmpty() {
                    return AbstractAqMap.this.isEmpty();
                }

                @Override
                public void clear() {
                    AbstractAqMap.this.clear();
                }

                @Override
                public boolean contains(Object k) {
                    return AbstractAqMap.this.containsKey(k);
                }
            };
            keySet = ks;
        }
        ...
        if (vals == null) {
            vals = new AbstractCollection<V>() {
                ...
                public boolean contains(Object v) {
                    return AbstractAqMap.this.containsValue(v);
                }
            };
            values = vals;
        }
    ...
    protected Object clone() throws CloneNotSupportedException {
        AbstractAqMap<?, ?> result = (AbstractAqMap<?, ?>) super.clone();
        result.keySet = null;
        result.values = null;
        return result;
    }
